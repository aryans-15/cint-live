...
const METHOD_NAME = 'problem.info'
...
export async function GET(request) {
  ...
  const params = { apiKey: process.env.NEXT_PUBLIC_CF_API_KEY, problemId, time: String(time) }
  ...
  return NextResponse.json({ problemInfo: json.result })
}

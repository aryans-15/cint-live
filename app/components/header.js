                    ...
                    <div className="justify-end flex-col text-gray-300" onClick={() => setConfirmLogout(!confirmLogout)}>
                        <div className="flex-row h-full">
                            <div className={`py-2 px-4 items-center flex  h-full rounded-xl cursor-pointer ${confirmLogout ? "bg-gray-700" : ""} hover:bg-gray-700  transition duration-300 ease-in-out`}>
                                ...
                                <p className="pl-2 font-bold">Hi, {user.displayName}</p>
                            </div>
                        </div>
                        {confirmLogout && (
                            <div onClick={handleSignOut} className={`${confirmLogout? "animate-fadeIn" : ""} font-bold cursor-pointer flex w-full h-fit p-2 rounded-xl bg-rose-600 hover:bg-rose-700 transition duration-300 ease-in-out mt-1`}>
